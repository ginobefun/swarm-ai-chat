            ...
            <div style={style}>
                <div ref={rowRef} className="px-4 py-2">
                    ...
                    <div className={`flex gap-3 group ${isUser ? 'flex-row-reverse' : ''}`}>
                        {/* Avatar */}
                        <div
                            className={`w-9 h-9 rounded-full flex items-center justify-center text-sm font-medium flex-shrink-0 shadow-sm ${
                                isUser
                        ...
                        <div className={`flex flex-col gap-1 max-w-[85%] sm:max-w-[80%] lg:max-w-[70%] min-w-0 ${isUser ? 'items-end' : 'items-start'}`}>
                            ...
                            <div className={`relative px-3 py-2 sm:px-4 sm:py-3 text-sm break-words shadow-sm ${
                                isUser
